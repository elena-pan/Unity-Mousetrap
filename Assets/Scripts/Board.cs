...
namespace MouseTrap
{
    public class Board : MonoBehaviour
    {
        ...
        private void SetUpGridPoints() 
        {
            ...
            this.locations[27].gridPoint = new Vector3();
            this.locations[28].gridPoint = new Vector3();
            this.locations[29].gridPoint = new Vector3();
            this.locations[30].gridPoint = new Vector3();
            this.locations[31].gridPoint = new Vector3();
            this.locations[32].gridPoint = new Vector3();
            this.locations[33].gridPoint = new Vector3();
            this.locations[34].gridPoint = new Vector3();
            this.locations[35].gridPoint = new Vector3();
            this.locations[36].gridPoint = new Vector3();
            this.locations[37].gridPoint = new Vector3();
            this.locations[38].gridPoint = new Vector3();
            this.locations[39].gridPoint = new Vector3();
            this.locations[40].gridPoint = new Vector3();
            this.locations[41].gridPoint = new Vector3();
            this.locations[42].gridPoint = new Vector3();
            this.locations[43].gridPoint = new Vector3();
            this.locations[44].gridPoint = new Vector3();
            this.locations[45].gridPoint = new Vector3();
            this.locations[46].gridPoint = new Vector3();
            this.locations[47].gridPoint = new Vector3();
            this.locations[48].gridPoint = new Vector3();
